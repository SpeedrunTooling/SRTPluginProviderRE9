...
public static class GameHashes
{
    ...
    private static readonly byte[] ww_20260508_1 = [0x16, 0xFD, 0x99, 0x50, 0x1B, 0xE1, 0xB2, 0x4A, 0xCF, 0x7B, 0xA2, 0x80, 0x22, 0x2A, 0xF9, 0x5A, 0x0D, 0xB4, 0xCB, 0x0B, 0xD0, 0x3E, 0x45, 0xFC, 0xF7, 0xD3, 0x77, 0xE6, 0x64, 0x1B, 0xBD, 0x65];
    ...
    public static GameVersion DetectVersion(string filePath)
    {
        ...
        if (checksum.SequenceEqual(ww_20260508_1))
        {
            Console.WriteLine("2026-05-08 version detected.");
            return GameVersion.WW_20260508_1;
        }
        else if (checksum.SequenceEqual(ww_20260327_1))
        {
