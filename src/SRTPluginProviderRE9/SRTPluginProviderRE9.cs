...
public class SRTPluginProviderRE9 : IPluginProvider
{
    private Process? process;
    private GameMemoryScanner? gameMemoryScanner;
    ...
    public bool GameRunning
    {
        get
        {
            ...
            return gameMemoryScanner is not null && gameMemoryScanner.ProcessRunning;
        }
    }
    ...
    public int Startup(IPluginHostDelegates hostDelegates)
    {
        ...
        process = GetProcess();
        gameMemoryScanner = new GameMemoryScanner(process);
    ...
    private Process GetProcess() => Process.GetProcessesByName("re9")?.FirstOrDefault();
}
