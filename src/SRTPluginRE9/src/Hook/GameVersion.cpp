...
namespace SRTPluginRE9::GameVersion
{
	...
	constinit std::array<uint8_t, 32> WW_20260508_1 = {0x16, 0xFD, 0x99, 0x50, 0x1B, 0xE1, 0xB2, 0x4A, 0xCF, 0x7B, 0xA2, 0x80, 0x22, 0x2A, 0xF9, 0x5A, 0x0D, 0xB4, 0xCB, 0x0B, 0xD0, 0x3E, 0x45, 0xFC, 0xF7, 0xD3, 0x77, 0xE6, 0x64, 0x1B, 0xBD, 0x65};
	...
	const std::expected<const GameVersion, std::string> DetectGameVersion()
	{
		...
		if (gameExeHash.value() == WW_20260508_1)
			return GameVersion::WW_20260508_1;
		else if (gameExeHash.value() == WW_20260327_1)
